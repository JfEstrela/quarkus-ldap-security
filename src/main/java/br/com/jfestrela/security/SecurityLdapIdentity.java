 ...
 * @since 4 Mac 2020
 */
public class SecurityLdapIdentity implements SecurityIdentity {
    ...
    private SecurityLdapIdentity(Builder builder) {
    ...
    public static class Builder {
        ...
        public SecurityLdapIdentity build() {
            built = true;
            return new SecurityLdapIdentity(this);
        }
    }
